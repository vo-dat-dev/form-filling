...
function YourMainContent({ themeColor }: { themeColor: string }) {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/mineru"
        className="mt-4 px-4 py-2 rounded-lg bg-white/20 hover:bg-white/30 text-white text-sm font-medium transition-colors"
      >
        📄 Open MinerU Document Assistant
      </Link>
      <Link
        href="/forms"
        className="mt-2 px-4 py-2 rounded-lg bg-white/20 hover:bg-white/30 text-white text-sm font-medium transition-colors"
      >
